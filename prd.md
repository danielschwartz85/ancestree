I want to create a static HTML page showcasing my ancestral family tree/s.

  we need to showcase multiple subtrees, as mermaid:

    9. לביא בארי שירה גיל אורי הלל ותמר
    [text](mermaid/core.mmd)

    8. רננה / איילה / משפחת אלון
  
    [text](mermaid/alon-renna-ayala.mmd)

    7. יערה / אחימן

    [text](mermaid/yaara-achiman.mmd)

    6. רווית / אוליבר / רומי
    
    [text](mermaid/ravit-oliver-romi.mmd)

    5. מלי / פלוטניק
    [text](mermaid/mali-plotnic.mmd)

    4. ניסים / לוי
    [text](mermaid/nissim-levi.mmd)

    3. ברקו / צביקה
    [text](mermaid/berko-tsvika.mmd)

    2. ברקו / משפחת ליזה

    [text](mermaid/berko-liza.mmd)

    1. וישן / לוי / שוורץ
    [text](mermaid/nissim-levi.mmd)
    
    0. פליקס שוורץ
    [text](mermaid/felix-schwartz.mmd)
